...
//
//     final searchLearningModel = searchLearningModelFromJson(jsonString);

import 'dart:convert';

class SearchLearningModel {
  SearchLearningModel({
    required this.code,
  ...
  factory SearchLearningModel.fromRawJson(String str) => SearchLearningModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory SearchLearningModel.fromJson(Map<String, dynamic> json) => SearchLearningModel(
        code: json["code"],
